...
CREATE TABLE "new_User" (
    ...
    "account_no" TEXT NOT NULL PRIMARY KEY DEFAULT '0023128790',
...
INSERT INTO "new_User" ("account_bal", "account_no", "created_at", "email", "fullName", "isAdmin", "password_hash", "phoneNumber", "verified") SELECT "account_bal", "account_no", "created_at", "email", "fullName", "isAdmin", "password_hash", "phoneNumber", "verified" FROM "User";
DROP TABLE "User";
