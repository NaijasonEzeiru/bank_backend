/*
  ...
  - You are about to alter the column `account_no` on the `User` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
...
CREATE TABLE "new_User" (
    ...
    "account_no" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT DEFAULT 23128790,
